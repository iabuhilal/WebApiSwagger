                ...
                .EnableSwagger(c =>
                    {
                      ...
                      c.SingleApiVersion("v1", "Swashbuckle. MMC Dummy")
                .Description("A sample API for testing and prototyping Swashbuckle features")
                .TermsOfService("Some terms")
                .Contact(cc => cc
                    .Name("Ihab AbuHilal")
                    .Url("http://wwww.mmcweb.com")
                    .Email("iabuhilal@mmcweb.com"))
                ;
                ...
                .EnableSwaggerUi(c =>
                    {
                     ...
                     // c.CustomAsset("index", thisAssembly, "WebApiSwagger.swagger.ui.index.html");
